import { buildConfirmationUrl, type AppointmentMessageData } from "@/lib/appointment-message"
...
/**
 * The hero of the confirmation screen. The barber already confirms over
 * WhatsApp; this only removes the typing, so it has to be the most obvious
 * thing on the screen and reachable with a thumb.
 */
