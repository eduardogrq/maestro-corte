      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8 py-16 sm:py-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-background/60">
              {business.openingHours.schedule.map((item) => (
                <li key={item.days}>
                  <span className="block">{item.days}</span>
                  <span className="block">{item.hours}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              <a
                ...
                className="flex items-center gap-1.5 text-sm text-background/60 hover:text-accent transition-colors duration-200"
              >
                <svg
                  width="13"
                  height="13"
