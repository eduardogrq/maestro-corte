 ...
 */
export function buildConfirmationMessage(appointment: AppointmentMessageData): string {
...
export function buildConfirmationUrl(appointment: AppointmentMessageData): string {
  return buildWhatsAppUrl(appointment.clientPhone, buildConfirmationMessage(appointment))
}
